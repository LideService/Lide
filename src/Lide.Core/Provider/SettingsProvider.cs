...
public class SettingsProvider : ISettingsProvider
{
    ...
    public PropagateSettings PropagateSettings { get; private set; } = null!;
    public string OriginRequestPath { get; private set; } = null!;
    ...
    public void Initialize(AppSettings appSettings, PropagateSettings propagateSettings, string originRequestPath)
    {
        AppSettings = appSettings;
        PropagateSettings = propagateSettings;
        OriginRequestPath = originRequestPath;
        PreparePatterns();
    }
