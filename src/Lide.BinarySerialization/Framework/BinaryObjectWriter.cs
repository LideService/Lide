...
#pragma warning restore 0649
    ...
    private long InternalGetId(object obj, bool assignUniqueIdToValueType, Type? type, out bool isNew)
    {
        ...
        var field = _idGenerator.GetType().GetFields(BindingFlags.Instance | BindingFlags.NonPublic).First(x => x.Name == "_currentCount");
        field.SetValue(_idGenerator, _currentId);
