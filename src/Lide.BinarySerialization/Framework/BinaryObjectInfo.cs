...
internal sealed class WriteObjectInfo
{
    ...
    private void InitMemberInfo()
    {
        ...
        if (_obj != null)
        {
            _memberData = Lide.BinarySerialization.Additions.FormatterServices.GetObjectData(_obj, _cache._memberInfos!);
        }
...
internal sealed class ReadObjectInfo
{
    ...
    internal void PopulateObjectMembers(object obj, object?[]? memberData)
    {
        ...
        {
            Debug.Assert(_cache != null && _cache._memberInfos != null);
            Lide.BinarySerialization.Additions.FormatterServices.PopulateObjectMembers(obj, _cache._memberInfos, memberData);
        }
    }
