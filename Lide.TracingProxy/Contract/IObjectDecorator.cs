...
namespace Lide.TracingProxy.Contract
{
    public interface IObjectDecorator
    {
        ...
        object[] ExecuteBefore(MethodInfo methodInfo, object[] methodParams);
        ...
        /// <param name="methodInfo">the method signature to be/is executed.</param>
        /// <param name="methodParams">params to be passed to the method..</param>
        void ExecuteAfter(MethodInfo methodInfo, object[] methodParams);
        ...
        T ExecuteAfter<T>(MethodInfo methodInfo, object[] methodParams, T methodResult);
        ...
        Exception ExecuteException(MethodInfo methodInfo, object[] methodParams, Exception exception);
        ...
        /// <param name="exception">exception thrown from the method, or wrapped in the return task.</param>
        /// <returns>exception - allows for the exception to be changed/replaced if needed.</returns>
        AggregateException ExecuteException(MethodInfo methodInfo, object[] methodParams, AggregateException exception);
        ...
        Task ExecuteAfter(MethodInfo methodInfo, object[] methodParams, Task methodResult);
        ...
        /// <returns>methodResult - allows for the task to be changed, replaced, appended, awaited if needed.</returns>
        Task<T> ExecuteAfter<T>(MethodInfo methodInfo, object[] methodParams, Task<T> methodResult);
    }
}