...
namespace Lide.TracingProxy.Contract
{
    ...
    /// It is exception safe. Even if the decorator throws an exception it will not affect the workflow.
    /// </summary>
    public interface IObjectDecoratorOld
    {
        /// <summary>
        ...
        /// <typeparam name="T">object or the `T` in `Task`T`.</typeparam>
