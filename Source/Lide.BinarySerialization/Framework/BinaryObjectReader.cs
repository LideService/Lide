    ...
    internal sealed class ObjectReader
    {
        ...
        internal object? TopObject
        {
            ...
            set
            {
                ...
                {
                    var fieldInfo = _objectManager.GetType().GetFields(BindingFlags.Instance | BindingFlags.NonPublic).First(x => x.Name == "_topObject");
                    fieldInfo.SetValue(_objectManager, value);
                }
            }
        }
        ...
        private void ParseObject(ParseRecord pr)
        {
            ...
            if (pr._dtType == null)
            {
                pr._newObj = new { TypeName = pr._keyDt };
                return;
            }
            ...
            {
                pr._newObj = Lide.BinarySerialization.Additions.FormatterServices.GetUninitializedObject(pr._dtType);
        ...
        internal Type? FastBindToType(string? assemblyName, string typeName)
        {
            ...
            if (entry == null || entry.AssemblyName != assemblyName)
            {
                ...
                {
                    type = Lide.BinarySerialization.Additions.FormatterServices.GetTypeFromAssembly(assm, typeName);
                }
        ...
        internal Type? GetType(BinaryAssemblyInfo assemblyInfo, string name)
        {
            ...
            else
            {
                ...
                if (objectType == null)
                {
                    ...
                    {
                        objectType = Lide.BinarySerialization.Additions.FormatterServices.GetTypeFromAssembly(sourceAssembly, name);
                    }
